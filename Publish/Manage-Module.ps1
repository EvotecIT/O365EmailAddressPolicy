...
$Configuration = @{
    Information = @{
        ModuleName        = 'O365EmailAddressPolicy'
        ...
        Manifest          = @{
            ...
            RequiredModules            = @(
                ...
                # @{ ModuleName = 'Transferetto'; ModuleVersion = 'Latest'; Guid = '7d61db15-9efe-41d1-a1c0-81d738975dec' }
            )
    ...
    Options     = @{
        Merge             = @{
            ...
            Integrate      = @{
                ApprovedModules = @('Graphimo', 'PSSharedGoods', 'PSWriteColor', 'Connectimo', 'PSUnifi', 'PSWebToolbox', 'PSMyPassword')
            }
        }
        Standard          = @{
            FormatCodePSM1 = @{
